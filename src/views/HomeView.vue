...
<template>
    <body>
        <main class="app">
            <h1 class="text-6xl text-center font-sans text-slate-400">
                JavaScript Quiz
            </h1>
            <section class="quiz" v-if="!quizCompleted">
                <!-- pembungkus -->
                <div
                    class="card h-[350px] w-[900px] mt-5 mx-auto bg-slate-800 rounded-md drop-shadow-md p-5"
                >
                        ...
                        >
                            <ul>
                                <li
                                    ...
                                    :class="`${
                                        getCurrentQuestion.clicked == index
                                            ? 'opacity-50'
                                            : ''
                                    }`"
                                >
                    ...
                    <button
                        @click="nextQuestion"
                        :disabled="!getCurrentQuestion.selected"
                        class="border-2 m-2 rounded-md w-[200px] h-[30px] bg-green-800 disabled:bg-red-900"
                    >
                        {{
